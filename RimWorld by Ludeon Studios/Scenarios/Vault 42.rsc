...
<savedscenario>
	<meta>
		<gameVersion>1.4.3537 rev237</gameVersion>
		<modIds>
			...
			<li>jangodsoul.theforge.anvil</li>
			<li>jangodsoul.theforge.ncrarmory</li>
			<li>derekbickley.legacyterrainoverhaulfinal</li>
			<li>limetreesnake.systems</li>
			<li>syrchalis.processor.framework</li>
			<li>rwnodetree.rwnodetree</li>
			<li>rwnodetree.rwweaponmodularization</li>
			...
			<li>biowreck.ancientfalloutarmory</li>
			<li>vanillaexpanded.vfemedical</li>
			<li>vanillaexpanded.vfea</li>
			<li>ifsck.ancientmedicallinking</li>
			<li>scpchemfuel.appliances</li>
			<li>bombadier.betterwallsandfloors</li>
			...
			<li>jangodsoul.t45b.powerarmor</li>
			<li>owlchemist.fridgeutilities</li>
			<li>seos.m.storages</li>
			...
			<li>owlchemist.perspectivetrees</li>
			...
			<li>bonible.medullinpure</li>
			<li>witek.mechscanhaultocharger</li>
			<li>hydrologist.mechanitorcommandrelays</li>
			<li>lwm.fuelfilter</li>
			<li>krafs.levelup</li>
			<li>jecrell.jecstools</li>
			<li>aoba.fortress.industrial.concrete</li>
			...
			<li>bs.mbifvte</li>
			<li>aoba.cargocontainer.waste</li>
			...
			<li>forza.diseasesoverhauledbiosculptor</li>
			<li>proxyer.dismantleancientjunk</li>
			<li>tikubonn.drugcommandoverhaul</li>
			...
			<li>jangodsoul.fallout.nukacola</li>
			<li>yeffscry.fallout2soundtrack</li>
			<li>yeffscry.fallout3soundtrack</li>
			<li>yeffscry.fallout4soundtrack</li>
			<li>yeffscry.fallout76soundtrack</li>
			<li>yeffscry.falloutnvsoundtrack</li>
			<li>mlie.falloutracestherobotspack</li>
			<li>yeffscry.falloutsoundtrack</li>
			<li>fuglypump.fallouttraits</li>
			<li>legendaryminuteman.frwp</li>
			<li>murmur.fasterprojectiles</li>
			...
			<li>edb.preparecarefully.alonske.fork.kotobike</li>
			<li>dopwop.simpledwarves</li>
			<li>mlie.apothecary</li>
			<li>iluvsilicon.basicmedicine2</li>
			<li>krkr.rule56</li>
			<li>uuugggg.tdfindlib</li>
			<li>uuugggg.ctrlf</li>
			<li>newcolonist.largefactionbases</li>
			...
			<li>seos.m.st.liaraangry</li>
			<li>vanillaexpanded.vcefaddon</li>
			<li>ogliss.g223.wanderingcaravans</li>
			<li>edb.preparecarefully.alonske.fork</li>
			<li>odz.40k.imperialguard.dkok</li>
			<li>odz.40k.ordotempestus.tempestusscions</li>
			<li>biotexpans.core</li>
			<li>enzo4ka12.biotexpans.core</li>
			<li>flangopink.disableautoselecttravelsupplies</li>
			<li>huhu.lions.ps2nsboarmor</li>
			<li>planetside2.ru</li>
			<li>uuugggg.tdsbugfixes</li>
			<li>brrainz.cameraplus</li>
			<li>hatti.cleaningarea</li>
			<li>kamikadza13.legodude17.qualcolor</li>
			<li>hatti.qualitybuilder</li>
			<li>uuugggg.replacestuff</li>
			<li>ru.pashka.uuugggg.replacestuff</li>
			<li>uuugggg.randomresearch</li>
			<li>owlchemist.researchpowl</li>
			<li>ru.pashka.vinalx.researchpalforked</li>
		...
		<modNames>
			<li>Harmony</li>
			<li>Core</li>
			<li>Better Log - Fix your errors with style</li>
			<li>Royalty</li>
			<li>Ideology</li>
			<li>Biotech</li>
			...
			<li>[JDS] The Forge - NCR Armory</li>
			<li>[LTO] Terrain Overhaul</li>
			<li>[LTS]Systems</li>
			...
			<li>Trait and Backstory Icons</li>
			...
			<li>Stack XXL</li>
			<li>SRTS Expanded</li>
			<li>Smarter Deconstruction and Mining</li>
			<li>Smarter Construction</li>
			<li>Smart Speed</li>
			<li>Smart Farming</li>
			<li>Slave Outfits [1.4]</li>
			...
			<li>Prisoners Are Not Swines</li>
			<li>Pick Up And Haul</li>
			<li>Perspective: Trees</li>
			<li>Perspective: Eaves</li>
			<li>Simple Utilities: Wall</li>
			<li>Perspective: Buildings</li>
			<li>Pawn Badge Fan Fork [Adopted]</li>
			<li>More Faction Interaction (Continued)</li>
			<li>Medullin Injector</li>
			<li>Mechs can haul to charger</li>
			...
			<li>Bradson's Main Button Icons for VE Textures</li>
			<li>Cargo waste container</li>
			<li>Cash Register</li>
			...
			<li>Common Sense</li>
			<li>Custom Pawn Generation</li>
			<li>Diseases Overhauled</li>
			<li>Diseases Overhauled - Biosculptor patch</li>
			<li>Dismantle Ancient Junk</li>
			<li>Drug Command Overhaul</li>
			...
			<li>Fabricors can repair mechs</li>
			<li>Fallout - Nuka Cola Collection</li>
			<li>Fallout 2 Soundtrack</li>
			<li>Fallout 3 Soundtrack</li>
			<li>Fallout 4 Soundtrack</li>
			<li>Fallout 76 Soundtrack</li>
			<li>Fallout New Vegas Soundtrack</li>
			<li>Fallout Races: The Robots Pack (Continued)</li>
			<li>Fallout Soundtrack</li>
			<li>Fallout Traits</li>
			<li>Fallout: Retro Weapon Pack</li>
			<li>Faster Projectiles</li>
			<li>Gastronomy</li>
			<li>Giddy-Up! Add-on: Animal Saddles</li>
			<li>Giddy-up! Battle Mounts</li>
			<li>Giddy-up! Caravan</li>
			<li>Giddy-up! Ride and Roll</li>
			<li>[1.4 FORK] EdB Prepare Carefully RUS</li>
			<li>[DW] Simple Dwarves</li>
			<li>Apothecary (Continued)</li>
			<li>Basic Medicine</li>
			<li>CAI 5000 - Advance Combat AI Mod</li>
			<li>TD Find Lib</li>
			<li>Ctrl F</li>
			...
			<li>Randomised Stone Refinery</li>
			<li>Rus Simple FX: Splashes</li>
			<li>Rus Simple FX: Vapor</li>
			<li>Simple Chains: Lumber</li>
			<li>Simple FX: Smoke</li>
			<li>Simple FX: Smoke Patches</li>
			<li>Simple FX: Splashes</li>
			<li>Simple FX: Vapor</li>
			<li>Simple Utilities: Ceiling</li>
			<li>Storyteller - Liara Livid</li>
			<li>Vanilla Fishing Expanded - Fishing Treasures AddOn</li>
			<li>Wandering Caravans</li>
			<li>[1.4 FORK] EdB Prepare Carefully</li>
			<li>[1.4] Astra Militarum Regimentum - Krieg</li>
			<li>[1.4] Ordo Tempestus - Tempestus Scions</li>
			<li>Biotech Expansion - Core</li>
			<li>Biotech Expansion - Core - Русская Локализация</li>
			<li>Disable Automatically Select Travel Supplies</li>
			<li>PlanetSide2 NS Black Ops Combat Armor</li>
			<li>PlanetSide2 NS Black Ops Combat Armor RU</li>
			<li>TDS Bug Fixes</li>
			<li>Camera+</li>
			<li>CleaningArea</li>
			<li>Quality Colors rus</li>
			<li>QualityBuilder</li>
			<li>Replace Stuff</li>
			<li>Replace Stuff Russian Language</li>
			<li>Random Research</li>
			<li>ResearchPowl</li>
			<li>ResearchPowl Russian Language</li>
			<li>Research Whatever</li>
		</modNames>
	</meta>
	<scenario>
		<name>Vault 42</name>
		<summary>Alone pawn guarding his post. 
Fallout Ancients experience.</summary>
		<description>With each passing day you stare at your fellow companions hibernating in cryptosleep sarcophagi. One day...
...
Note: Since you start alone with random superpowers and weaknesses, this is a difficult scenario.</description>
		...
		<parts>
			<li Class="ScenPart_GameStartDialog">
				...
				<text>With each passing day you stare at your fellow companions hibernating in cryptosleep sarcophagi. One day...

Will today be the day you not only wake up, but also open your eyes?</text>
